...
@section('title', 'Dashboard - Doanh nghiệp phế liệu')
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">
                        <i class="fas fa-leaf text-success"></i> PHELI GREEN SCORE
                    </h6>
                </div>
                <div class="card-body text-center py-4">
                    <div class="mb-3">
                        <h1 class="display-3 text-success mb-0 mt-3" style="font-weight: 700;">
                            {{ number_format($greenScore, 0) }}
                        </h1>
                        <p class="text-muted mb-0 mt-2" style="font-size: 1.1rem;">Points</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('waste-company.posts') }}" class="btn btn-sm btn-primary">Xem tất cả</a>
                </div>
                <div class="card-body">
